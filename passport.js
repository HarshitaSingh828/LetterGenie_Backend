...
// passport.serializeUser((user, done) => { // basically to store user data into cookie session.
//     done(null, user);
// });
...
// passport.deserializeUser((user, done) => {// to get data from cs.
//     done(null, user);
// });
...
passport.use(
    new GoogleStrategy(
        {
            clientID:"654585378760-e7hddhr6m8r4numm9tgck9ojkq9l14nv.apps.googleusercontent.com",
            clientSecret: "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",
            callbackURL: "/auth/google/callback",
            scope: ["profile", "email"],
        },
        function (accessToken, refreshToken, profile, callback) {
